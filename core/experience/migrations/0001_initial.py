# Generated by Django 4.0.4 on 2022-05-30 17:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.TextField(blank=True, max_length=250, null=True, unique=True)),
                ('addres', models.OneToOneField(max_length=250, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Post',
